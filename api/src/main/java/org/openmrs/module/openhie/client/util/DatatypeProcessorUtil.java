...
public final class DatatypeProcessorUtil {
	 ...
	 */
	public void cascade(IGraphable source, IGraphable destination, String... propertyNames) throws HealthInformationExchangeException
	{
	 ...
	 * @throws DocumentImportException 
	 *
	public OrderFrequency getOrCreateOrderFrequency(ANY frequency) throws HealthInformationExchangeException {
...
*/
	...
	public PersonAddress parseAD(AD ad) throws HealthInformationExchangeException {
		...
		/*if(ad.getUseablePeriod() != null && ad.getUseablePeriod().getHull() instanceof IVL)
		{
			...
			throw new HealthInformationExchangeException("Complex GTS instances are not supported for usablePeriod. Please use GTS with IVL");*/
		return address;
	}
